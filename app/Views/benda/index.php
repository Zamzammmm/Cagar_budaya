                ...
                <tbody>
                    ...
                    foreach ($benda as $b) { ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <!-- Buutton edit-->
                                <button type="submit" class="btn btn-primary edit" id="edit" data-id="<?= $b['id'] ?>">
                                    <i class="fa fa-edit"></i> Edit
                                </button>
                                <!--  -->
                                <!-- Buutton Delete-->
                                <form action="/benda/<?= $b['id']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Buat Artikel Benda</h5>
                <button type="button" id="close" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="/benda/save" id="formBenda" method="post" enctype="multipart/form-data">
...
<script>
    $('.edit').click(function() {
        $('#exampleModalLabel').html('Form Edit Data Benda');
        var id = $(this).data('id');
        $('#formBenda').attr('action', '/benda/update/' + id);
