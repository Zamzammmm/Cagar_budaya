                    ...
                    foreach ($struktur as $s) { ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <!--  -->
                                <!-- Buutton Delete-->
                                <form action="/struktur/<?= $s['id']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Buat Artikel Struktur</h5>
...
<script>
    $('.edit').click(function() {
        $('#exampleModalLabel').html('Form Edit Data Struktur');
        var id = $(this).data('id');
        $('#formStruktur').attr('action', '/struktur/update/' + id);

        // alert(id);
        $.ajax({
            url: 'struktur/edit' + '/' + id,
            method: 'get',
            data: {
                id: id
            },
